...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
  HAL_PCDEx_SetRxFiFo(&hpcd_USB_OTG_FS, 0x80); // EP1 And EP3 接收节点

  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_FS, 0, 0x40); // EP0 内核控制节点，size=64*4=256Byte
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_FS, 1, 0x20); // EP1 CDC发送节点，size=128*4=512Byte
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_FS, 2, 0x20); // EP2 CDC控制节点，size=64*4=256Byte
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_FS, 3, 0x40); // EP3 HID接收节点，size=64*4=256Byte
  }
  return USBD_OK;
}
